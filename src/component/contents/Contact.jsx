    ...
    return (
        <div className='flex h-full text-[20px] font-consolas'>
            ...
            <div>
                ...
                <div className="key">github: 
                    <a href="https://github.com/KION126" target='_blank' rel="noreferrer" className="value">"</a>
                    <a href="https://github.com/KION126" target='_blank' rel="noreferrer" className="value hover:underline hover:underline-offset-4">KION126</a>
                    <a href="https://github.com/KION126" target='_blank' rel="noreferrer" className="value">"</a>
                    <span className='syntax'>,</span>
                </div>
                <div className="key">kakao: 
                <a href="https://github.com/KION126" target='_blank' rel="noreferrer" className="value">"</a>
                    <a href="https://open.kakao.com/o/sgkFLnXg" target='_blank' rel="noreferrer" className="value hover:underline hover:underline-offset-4">Kakao Open Chat</a>
                    <a href="https://github.com/KION126" target='_blank' rel="noreferrer" className="value">"</a>
                    <span className='syntax'>,</span>
                </div>
