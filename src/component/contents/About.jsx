...
const About = () => {
  ...
  return (
    <div className="flex h-fit text-[20px] font-consolas text-[#c1cccc] text-nowrap leading-[29.6px]">
      <LineNumbers lines={59} />
      <div>
        <div>
        ...
        <div className="span-group">
              ...
              <div className="font-kr flex flex-col">
                <div className="!-ml-[30px] flex flex-col border-l-[2px] border-[#404040] pl-[20px]">
                  <span>
                    안녕하세요!
                    <br />
                    저는 개발의 왕이 되고 싶은 왕건입니다!
                  </span>
                  <span>
                    프론트엔드와 백엔드 모두에 깊은 관심을 가지고 있으며, 기술과
                    창의력을 결합하여 다양한 문제를 해결하는 것을 좋아합니다.
                    <br />
                    새로운 기술과 트렌드를 적극적으로 학습하고 적용하는 것을
                    좋아하며, 최근에는 AI에 대한 관심이 생겨 AI와 웹을 결합한
                    서비스를 개발하고자 합니다.
                    <br />
                    특히 자연어 처리와 이미지 인식 등의 분야에 관심이 있으며,
                    이를 웹 개발에 적용하여 사용자에게 더욱 편리하고 유용한
                    서비스를 제공하고자 합니다.
                    <br />
                    이를 위해 Node.js와 MongoDB를 이용한 서버 개발을 공부하고
                    있으며, Python과 TensorFlow 등의 AI 라이브러리도 함께
                    학습하고 있습니다.
                  </span>
                  <br />
                  <span>
                    저의 장점은 빠른 습득력과 더 나은 결과물을 위해 절대
                    포기하지 않고 끝까지 노력하는 것입니다.
                  </span>
                  <span>
                    방학 동안 '브이드림'에서 프론트엔드 개발자로 일하며 React와
                    RESTful API를 사용해 내부 관리 시스템을 개발한 경험이
                    있습니다.
                  </span>
                  <span>
                    해당 프로젝트에서는 사용자의 요구사항을 파악하고, 이를
                    바탕으로 시스템을 설계하고 구현하는 과정에서 많은 어려움을
                    겪었습니다.
                  </span>
                  <span>
                    하지만 저는 포기하지 않고 끝까지 노력했습니다. 문제를
                    해결하기 위해 다양한 방법을 시도하고, 다른 사람들의 조언을
                    구하며, <br />제 자신의 부족한 점을 보완하기 위해 노력하여
                    프로젝트에 기여할 수 있었습니다. <br />이 경험은 저에게 큰
                    자신감을 주었고, 앞으로 더 나은 개발자가 되기 위한
                    동기부여가 되었습니다.
                  </span>
                  <br />
                  <span>
                    앞으로도 지속적인 학습과 경험을 통해 더욱 뛰어난 개발자가
                    되기 위해 노력할 것입니다.
                  </span>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="font-kr">
                <div className="!-ml-[30px] flex flex-col border-l-[2px] border-[#404040] pl-[20px]">
                  ...
                  <div className="ml-[30px] flex flex-col">
                    <span>
                      - Java, C#, C, Python, JSP, Spring Boot, MySQL, OracleDB,
                      MariaDB, Firebase
                    </span>
                  </div>
                  <br />
                  ...
                  <div className="ml-[30px] flex flex-col">
                    <span>
                      - Git, Notion, Postman, VS, VSCode, Eclipse, Figma, AWS,
                      Linux
                    </span>
                  </div>
                </div>
          ...
          <div className="span-group">
            <div>
              ...
              <span className="key"> class</span>
              <span className="syntax">=</span>
              <span className="value font-kr font-semibold">
                '학력 및 경력'
              </span>
              <span className="syntax">&gt;</span>
              ...
              <div className="font-kr flex flex-col">
                <div className="!-ml-[30px] flex flex-col border-l-[2px] border-[#404040] pl-[20px]">
                  ...
                  <div className="ml-[30px] flex flex-col">
                    <div>
                      <span
                        className="underline decoration-[#c1cccc]"
                        href="https://www.vdream.co.kr/"
                        target="__brank"
                      >
                        군자디지털과학고등학교
                      </span>
                  ...
                  <div className="ml-[30px] flex flex-col">
                    ...
                    <div className="ml-[20px] flex flex-col">
                      ...
                      <span>- 내부관리시스템 프론트엔드 개발(React)</span>
                    </div>
                    <div>
                      <a
                        className="underline decoration-[#c1cccc]"
                    ...
                    <div className="ml-[20px] flex flex-col">
                      <span>
                        - 내부관리시스템 풀스택 개발 및 유지보수(React, FastAPI)
                      </span>
                    </div>
                  </div>
                </div>
